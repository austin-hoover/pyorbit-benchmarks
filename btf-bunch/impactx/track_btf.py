...
mstate_file = None
bunch_file = '../common-inputs/bunch/initial_bunch_20k_40mA_waterbag.dat'
...
### load and set bunch coordinates
bunch = bunch_utilities.pyorbit_to_impactx(bunch_file)
